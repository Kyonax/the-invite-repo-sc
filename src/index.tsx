          ...
          <div class="preloader-animation">
            <div class="loading-bar">
              ...
              <svg
                ...
                width="150px"
                height="150px"
                viewBox="0 0 1280.000000 1046.000000"
                xmlns="http://www.w3.org/2000/svg"
                style={{ transform: `translateX(${dotPosition}px)` }} // Dynamically set position
              ...
              >
                ...
                >
                  <path
                    d="M3885 10436 c-253 -66 -416 -158 -895 -505 -231 -167 -217 -148 -219
